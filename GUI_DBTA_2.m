...
% Der String wird gesucht, der mit dem Namen Versuchszeit 11 character
% gemeinsam hat
...
% - (handles.sekunden(startzeit) - handles.sekunden(1));
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Ab hier automatischen Speichern der zugeschnittenen Daten
logVal = handles.logVal;
logIDs = handles.logIDs;
